...
class GlobalSettingController extends GetxController {
  ...
  void onInit() {
    ...
    // Run heavy work AFTER first frame — prevents lag
  ...
  Future<void> getInterCityService() async {
    return FireStoreUtils.fetchIntercityService();
  }
  ...
  Future<void> getCurrentCurrency() async {
    ...
    await Future.wait([
      FireStoreUtils().getAdminCommission(),
      FireStoreUtils().getPayment(),
      FireStoreUtils().getSettings(),
    ]);
  ...
  Future<void> getVehicleTypeList() async {
    final list = await FireStoreUtils.getVehicleType();
    Constant.vehicleTypeList = list;
  }

  Future<void> getLanguage() async {
    String languageCode = await Preferences.getString(Preferences.languageCodeKey);
